...
case "${LANG:-}" in
    ...
    he_* ) text="הליענה לטבל המסיס דלקה" ;; # Hebrew עברית (convert does not play bidi well)
...
if [[ $color -gt $value ]]; then #white background image and black text
    bw="black"
    icon="/home/$USER/.config/qtile/scripts/i3lock-fancy/circlelockdark.png"
    ...
    bw="white"
    icon="/home/$USER/.config/qtile/scripts/i3lock-fancy/circlelock.png"
